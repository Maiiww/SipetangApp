...
<head>
    ...
    <style>
        ...
        /* HERO SECTION */
        .hero-section {
            background-image: url('<?php echo e(asset("assets/../../images/Container.png")); ?>');
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6 col-lg-3 reveal">
                            <div class="tpi-card h-100">
                                <img src="<?php echo e(asset('assets/../../images/patimban.png')); ?>" alt="TPI Patimban" class="tpi-img">
                                <div class="p-3">
                        ...
                        <div class="col-md-6 col-lg-3 reveal reveal-delay-1">
                            <div class="tpi-card h-100">
                                <img src="<?php echo e(asset('assets/../../images/genteng.png')); ?>"  class="tpi-img" alt="TPI Genteng">
                                <div class="p-3">
                        ...
                        <div class="col-md-6 col-lg-3 reveal reveal-delay-2">
                            <div class="tpi-card h-100">
                                <img src="<?php echo e(asset('assets/../../images/mayangan.png')); ?>" class="tpi-img" alt="TPI Mayangan">
                                <div class="p-3">
                        ...
                        <div class="col-md-6 col-lg-3 reveal reveal-delay-3">
                            <div class="tpi-card h-100">
                                <img src="<?php echo e(asset('assets/../../images/cirewang.png')); ?>" class="tpi-img" alt="TPI Cirewang">
                                <div class="p-3">
                        ...
                        <div class="col-md-6 col-lg-3 reveal">
                            <div class="tpi-card h-100">
                                <img src="<?php echo e(asset('assets/../../images/muaraciasem.png')); ?>" class="tpi-img" alt="TPI Muara Ciasem">
                                <div class="p-3">
                        ...
                        <div class="col-md-6 col-lg-3 reveal reveal-delay-1">
                            <div class="tpi-card h-100">
                                <img src="<?php echo e(asset('assets/../../images/blanakan.png')); ?>" class="tpi-img" alt="TPI Blanakan">
                                <div class="p-3">
                        ...
                        <div class="col-md-6 col-lg-3 reveal reveal-delay-2">
                            <div class="tpi-card h-100">
                                <img src="<?php echo e(asset('assets/../../images/rawameneng.png')); ?>" class="tpi-img" alt="TPI Rawameneng">
                                <div class="p-3">
                        ...
                        <div class="col-md-6 col-lg-3 reveal reveal-delay-3">
                            <div class="tpi-card h-100">
                                <img src="<?php echo e(asset('assets/../../images/cilamayagirang.png')); ?>" class="tpi-img" alt="TPI Cilamaya Girang">
                                <div class="p-3">
    ...
    <div class="transition-overlay" id="pageTransitionOverlay">
        ...
        <div class="transition-content">
            <div class="transition-logo-wrapper">
                ...
                <img src="<?php echo e(asset('assets/../../images/logo.png')); ?>" alt="SIPETANG" class="transition-logo">
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\SipetangApp\web-laravel\resources\views/welcome.blade.php ENDPATH**/ ?>