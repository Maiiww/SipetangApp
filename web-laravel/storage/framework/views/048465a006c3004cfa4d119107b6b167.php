                ...
                <?php $__empty_1 = true; $__currentLoopData = $aktivitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="activity-item">
                        <div class="activity-avatar"
                            style="background-color: <?php echo e($item['avatarBg']); ?>; color: #0d2640;">
                            <?php echo e($item['avatar']); ?>

                        </div>
                        <div class="activity-content">
                            <div class="activity-name"><?php echo e($item['nama']); ?></div>
                            ...
                            <div style="font-size:11px; color:#555; margin-top:3px;">
                                <?php echo e($item['jenis']); ?> &bull; <?php echo e(number_format($item['berat'], 1)); ?> kg
                            </div>
                            <?php
                                $statusMap = [
                            ...
                            ?>
                            <span class="activity-status <?php echo e($statusInfo['class']); ?>">
