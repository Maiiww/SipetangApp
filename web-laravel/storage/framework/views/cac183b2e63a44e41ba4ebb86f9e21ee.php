...
<head>
    ...
    <style>
        * {
        ...
        .revision-card { background: #ffffff; border: 1.5px solid #fee2e2; border-radius: 18px; padding: 24px; display: flex; flex-direction: column; gap: 18px; box-shadow: 0 6px 20px rgba(239, 68, 68, 0.03); transition: all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275); position: relative; overflow: hidden; }
        .revision-card::before { content: ''; position: absolute; left: 0; top: 0; bottom: 0; width: 4px; background: #ef4444; border-radius: 4px 0 0 4px; }

        .revision-card:hover { transform: translateY(-6px); box-shadow: 0 15px 35px rgba(239, 68, 68, 0.08); border-color: #fca5a5; }
