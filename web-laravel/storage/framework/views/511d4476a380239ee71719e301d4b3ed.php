        ...
        <div class="row g-5 mb-5">
            <div class="col-lg-5">
                ...
                <div class="d-flex align-items-center gap-3 mb-3">
                    <img src="<?php echo e(asset('assets/../../images/logo.png')); ?>" alt="Logo SIPETANG" width="40" height="40" class="rounded-circle border border-2 border-white shadow-sm" style="object-fit: cover; background-color: white;">
            ...
            <div class="col-lg-3">
                ...
                <div class="d-flex flex-column gap-2">
                    <a href="<?php echo e(url('/login')); ?>" class="text-white text-decoration-none opacity-75 hover-opacity-100">Beranda Statistik</a>
                    <a href="<?php echo e(url('/login')); ?>" class="text-white text-decoration-none opacity-75 hover-opacity-100">Validasi Laporan</a>
                    <a href="<?php echo e(url('/login')); ?>" class="text-white text-decoration-none opacity-75 hover-opacity-100">Cetak Dokumen</a>
                </div>
            </div>
        </div>
